Shader "Custom/NormalMapWarpUI"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float2 normalUV = IN.texcoord * _NormalMap_ST.xy + _NormalMap_ST.zw;
                ...
                float2 baseUV = IN.texcoord * _MainTex_ST.xy + _MainTex_ST.zw;
                ...
                half4 color = IN.color * (tex2D(_MainTex, warpedUV) + _TextureSampleAdd);

...
public class GrassPainterWindow : EditorWindow
{
    ...
    void EnsureToolSettings()
    {
        ...
        toolSettings = (SO_GrassToolSettings)AssetDatabase.LoadAssetAtPath("Assets/Settings/grassToolSettings.asset", typeof(SO_GrassToolSettings));
        if (toolSettings == null)
        {
            ...
            AssetDatabase.CreateAsset(toolSettings, "Assets/Settings/grassToolSettings.asset");
    ...
    private void OnEnable()
    {
        ...
        // Runs whenever the window is created, including when the editor restores
        // it from a saved layout after a domain reload — where Init() never runs.
        EnsureToolSettings();
    }

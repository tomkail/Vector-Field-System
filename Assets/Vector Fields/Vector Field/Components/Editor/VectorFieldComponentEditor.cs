...
public class VectorFieldComponentEditor : BaseEditor<VectorFieldComponent> {
	...
	public override void OnEnable() {
		...
		maxComponent = VectorFieldScriptableObject.GetMaxAbsComponent(data.vectorField.values);
	}
	...
	public override void OnPreviewSettings() {
		automaticScale = GUILayout.Toggle(automaticScale, new GUIContent("Auto Scale"), EditorStyles.toolbarButton, GUILayout.Width(80));

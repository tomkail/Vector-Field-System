...
public static class MultitouchDraggableMenuItems {
	[MenuItem("GameObject/UI (Canvas)/Multitouch Draggable", false, 2101)]
	static void CreateMultitouchDraggable (MenuCommand menuCommand) {
		var go = new GameObject("Multitouch Draggable", typeof(RectTransform), typeof(Image), typeof(MultitouchDraggable));
		go.GetComponent<MultitouchDraggable>().targetGraphic = go.GetComponent<Image>();

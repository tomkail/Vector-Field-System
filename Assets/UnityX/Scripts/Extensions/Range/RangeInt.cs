...
/// NOTE: this lives in the global namespace and so shadows/collides with
/// UnityEngine.RangeInt (a start+length struct). See the class-level docs in the repo review.
/// </summary>
[Serializable]

...
public class FloatMap3D : TypeMap3D<float> {
	...
	public FloatMap3D (Vector3Int _size) : base (_size) {}
	public FloatMap3D (Vector3Int _size, float _value) : base (_size, _value) {}
	public FloatMap3D (Vector3Int _size, float[] _mapArray) : base (_size, _mapArray) {}
